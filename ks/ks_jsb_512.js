...
class ksUser {
    ...
    async luckdrawTasksReward(_0x548292) {
        ...
        _0x3417ed.result == 1
            ...
            _0x548292.taskTitle +
            ']奖励获得'
            // _0x3417ed.data.popUp && _0x3417ed.data.popUp.taskRewardName ? _0x3417ed.data.popUp.taskRewardName : _0x3417ed.data.popUp
            )
            : console.log(
            '账号[' +
            this.name +
...
!(async () => {
    ...
    for (let u of CurrentUser) {
        ...
        console.log(u.task[taskIds.luckydraw])
