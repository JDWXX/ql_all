...
IOS/安卓：都爱玩
下载注册地址：
http://cxgc.top/upload/2021/12/%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20211224100317-d5a98afbc2b6476ba1fe0ce7296af651.jpg
...
感谢原作者提供的脚本 https://raw.githubusercontent.com/leafxcy/JavaScript/main/daw.js
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
============Quantumultx===============
[task_local]
#都爱玩
3 1,20 * * * https://github.com/JDWXX/ql_all/blob/master/daw/daw.js, tag=都爱玩, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "3 1,20 * * *" script-path=https://github.com/JDWXX/ql_all/blob/master/daw/daw.js,tag=都爱玩

===============Surge=================
都爱玩 = type=cron,cronexp="3 1,20 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/daw/daw.js

============小火箭=========
都爱玩 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/daw/daw.js, cronexpr="3 1,20 * * *", timeout=3600, enable=true
*/
const $ = new Env('都爱玩');
const jsname = '都爱玩'
const logDebug = 0
...
let notifyFlag= $.isNode() ? (process.env.dawNotify ? process.env.dawNotify : 1) : ($.getdata('dawNotify') ? $.getdata('dawNotify') : 1)
let notifyStr = ''
...
let dawToken= $.isNode() ? (process.env.dawToken ? process.env.dawToken : '') : ($.getdata('dawToken') ? $.getdata('dawToken') : '')
let dawTokenArr = []
