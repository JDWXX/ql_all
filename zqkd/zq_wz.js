...
[task_local]
#中青看点阅读文章
15 10 * * * https://github.com/JDWXX/ql_all/blob/master/zqkd/zq_wz.js, tag=中青看点阅读文章, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "15 10 * * *" script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_wz.js,tag=中青看点阅读文章

===============Surge=================
中青看点阅读文章 = type=cron,cronexp="15 10 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_wz.js

============小火箭=========
中青看点阅读文章 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_wz.js, cronexpr="15 10 * * *", timeout=3600, enable=true
*/
