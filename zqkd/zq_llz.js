...
[task_local]
#中青看点浏览赚
34 6 * * * https://github.com/JDWXX/ql_all/blob/master/zqkd/zq_llz.js, tag=中青看点浏览赚, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "34 6 * * *" script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_llz.js,tag=中青看点浏览赚

===============Surge=================
中青看点浏览赚 = type=cron,cronexp="34 6 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_llz.js

============小火箭=========
中青看点浏览赚 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_llz.js, cronexpr="34 6 * * *", timeout=3600, enable=true
*/
...
if (zqllzbody) {
    ...
    } else if (process.env.zqllzbody && process.env.zqllzbody.indexOf('&') > -1) {
        zqllzbodyArr = process.env.zqllzbody.split('&');
...
Object.keys(zqllzbodys).forEach((item) => {
    if (zqllzbodys[item] && !zqllzbodys[item].startsWith("#")) {
        zqllzbodyArr.push(zqllzbodys[item])
    }
})
...
async function getzqllzbody() {
    if ($request.url.match(/\/kandian.wkandian.com\/v5\/task\/browse_start/)) {
        ...
        if (zqllzbody) {
            ...
            } else if (zqllzbody.indexOf(bodyVal) == -1) {
                zqllzbodys = zqllzbody + "&" + bodyVal;
