...
[task_local]
#中青看点阅读翻倍
34 5 * * 1 https://github.com/JDWXX/ql_all/blob/master/zqkd/zq_double.js, tag=中青看点阅读翻倍, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "34 5 * * 1" script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_double.js,tag=中青看点阅读翻倍

===============Surge=================
中青看点阅读翻倍 = type=cron,cronexp="34 5 * * 1",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_double.js

============小火箭=========
中青看点阅读翻倍 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_double.js, cronexpr="34 5 * * 1", timeout=3600, enable=true
*/
