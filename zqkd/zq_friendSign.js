...
[task_local]
#中青看点好友签到红包
15 7 * * * https://github.com/JDWXX/ql_all/blob/master/zqkd/zq_friendSign.js, tag=中青看点好友签到红包, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "15 7 * * *" script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_friendSign.js,tag=中青看点好友签到红包

===============Surge=================
中青看点好友签到红包 = type=cron,cronexp="15 7 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_friendSign.js

============小火箭=========
中青看点好友签到红包 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_friendSign.js, cronexpr="15 7 * * *", timeout=3600, enable=true
*/
