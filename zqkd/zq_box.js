...
[task_local]
#中青看点任务宝箱领取
15 22 * * * https://github.com/JDWXX/ql_all/blob/master/zqkd/zq_box.js, tag=中青看点任务宝箱领取, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "15 22 * * *" script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_box.js,tag=中青看点任务宝箱领取

===============Surge=================
中青看点任务宝箱领取 = type=cron,cronexp="15 22 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_box.js

============小火箭=========
中青看点任务宝箱领取 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_box.js, cronexpr="15 22 * * *", timeout=3600, enable=true
*/
