...
[task_local]
#中青看点签到
15 2 * * * https://github.com/JDWXX/ql_all/blob/master/zqkd/zq_qd.js, tag=中青看点签到, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "15 2 * * *" script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_qd.js,tag=中青看点签到

===============Surge=================
中青看点签到 = type=cron,cronexp="15 2 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_qd.js

============小火箭=========
中青看点签到 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_qd.js, cronexpr="15 2 * * *", timeout=3600, enable=true
*/
