...
[task_local]
#中青看点搜索赚
35 5 * * * https://github.com/JDWXX/ql_all/blob/master/zqkd/zq_ssz.js, tag=中青看点搜索赚, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "35 5 * * *" script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_ssz.js,tag=中青看点搜索赚

===============Surge=================
中青看点搜索赚 = type=cron,cronexp="35 5 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_ssz.js

============小火箭=========
中青看点搜索赚 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_ssz.js, cronexpr="35 5 * * *", timeout=3600, enable=true
*/
