...
[task_local]
#中青看点看看赚
45 9 * * * https://github.com/JDWXX/ql_all/blob/master/zqkd/zq_kkz.js, tag=中青看点看看赚, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "45 9 * * *" script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_kkz.js,tag=中青看点看看赚

===============Surge=================
中青看点看看赚 = type=cron,cronexp="45 9 * * *",wake-system=1,timeout=3600,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_kkz.js

============小火箭=========
中青看点看看赚 = type=cron,script-path=https://github.com/JDWXX/ql_all/blob/master/qsk/zq_kkz.js, cronexpr="45 9 * * *", timeout=3600, enable=true
*/
