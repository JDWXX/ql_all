...
lxsyck:PHPSESSID=xxxxxxxxxxxxx
export lxsyck='PHPSESSID=xxxxxxxxxxxxx'
多账户用@隔开
...
!(async () => {
  if (typeof $request !== "undefined") {
    ...
    if (!$.isNode()) {
      ...
      let count = ($.getval('lxsyckcount') || '1');
